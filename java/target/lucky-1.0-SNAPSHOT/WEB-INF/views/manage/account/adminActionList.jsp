    ...
    <script type="text/javascript">
        ...
        function delUser(id) {
            bootbox.confirm("是否确认删除?", function (result) {
                if (result) {
                    location.href = '${pageContext.request.contextPath}' + "/admin/action/delete/" + id;
                }
            });
        }
    </script>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <table class="table  table-hover">
                ...
                <tbody>
                <c:forEach var="action" items="${actionPage.content}" varStatus="status">
                    <tr>
                        <td>
                                ${action.id}
                        </td>
                        ...
                        <shiro:hasPermission name="admin:action:edit">
                            <td>
                                ...
                                <a href="javascript:delUser(${action.id});" data-bb="confirm"
...
<script type='text/javascript'>
    ...
    var options = {
        currentPage: '${actionPage.number+1}',
    ...
    $('#alert-content').text("总共${actionPage.totalPages}页 ${actionPage.totalElements}条  每页${actionPage.size}条");
